...
from concurrent.futures import ThreadPoolExecutor as Alvissb
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ALVI TRICKER
\033[1;37m Facebook:            ﹾ٭ﹾ٭ﹾ ﹾ٭ﹾ٭ﹾ ﹾ٭ﹾ٭ﹾ ﹾ٭ﹾ٭ﹾ
\033[1;37m Github  :            Alvi-Vai
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with Alvissb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    Alvi = input('Saving Put File Name :')
    os.system('touch ' +Alvi)
    os.system('sort -r '+ssb+' | uniq > '+Alvi)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + Alvi )
    print(47*'-')
